function mostFrequentWord(words) {
	...
	{
		if(words[x] in frequentWords)
		{
			frequentWords[words[x]]++;
		}
		else
		{
			frequentWords[words[x]] = 1;
		}
	}

	var maxKey = Object.keys(frequentWords)[0];
	var count = frequentWords[maxKey];

	for(var x in frequentWords)
	{
		if (frequentWords[x] > count)
		{
			maxKey = x;
			count = frequentWords[x];
		}
	}
	return maxKey;
  // your code here
